...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <form action="addstudent.php" method="POST">
            ...
            <input type="text" name="txtpmob" placeholder="Enter Parent's Mobile Number" class="form-control mt-1" maxlength="10" required>
    ...
    <div class="container-fluid"><input type="text" class="from-control"></div>
