  ...
  <table class="table table-sm table-bordered">
    ...
    ?>
      <tr>
		...
		<td><a href="editstudent.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-pen text-warning"></i></a>&nbsp;&nbsp;<a href="deletestudent.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-trash text-danger"></i></a></td>
      </tr>
    <?php
    }
    ?>
