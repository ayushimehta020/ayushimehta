  ...
  <table class="table table-sm table-bordered">
    ...
    ?>
      <tr>
		...
		<td>
			<i class="fas fa-pen text-primary" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-sname="<?php echo $rows['student_name']; ?>" data-bs-mob="<?php echo $rows['mobile']; ?>" data-bs-pmob="<?php echo $rows['parents_mobile']; ?>" data-bs-dob="<?php echo $rows['dob']; ?>"></i>&nbsp;&nbsp;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="pmob1" name="pmob1">
            <input type="date" class="form-control" id="dob1" name="dob1">
			<select name="course1" class="form-control mt-1" id="course1">
				<option value="BCA">BCA</option>
				<option value="BSCIT">BSCIT</option>
			</select>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary w-100">Edit Student</button>
      </div>
    </div>
  </div>
</div>
<script>
	$( document ).ready(function() {
		$("#course1").course.setAttribute("selected","selected");
	});
